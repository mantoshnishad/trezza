<div>
    ...
    <div class="py-3">
        <h4><span>All Project</h4>
    </div>
    <div class="border overflow-auto">
        <div class=" mx-2 py-2">
            <h5 class="text-center rounded-pill text-white py-1" style="font-weight: 500; background-color: rgb(153,27,67); width:120px;">
               <a href="{{asset('master/add-project')}}" class="text-white">Add Job<span> + </span></a></h5>
        </div>
                ...
                <tbody class="w-100 border">
                    <table class="w-100 border">
                        ...
                        <tr class="text-center py-4">
                            ...
                            <td class="border text-center py-4"><span class="bg-info rounded-pill px-2">Live</span></td>
                            <td class="border text-center py-4"><span class="bg-success rounded-pill px-2">J49331</span></td>
                        </tr>
                    </table>
                </tbody>
