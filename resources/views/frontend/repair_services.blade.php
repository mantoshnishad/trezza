...
<div class="lg:absolute lg:top-[800px] grid lg:grid-cols-2 gap-5 mx-10 my-10 lg:p-8 bg-white lg:drop-shadow-lg lg:shadow-xl">
    <div class="grid place-content-center text-center">
        ...
        <h4 class="text-4xl my-2 font-medium">REPAIR SERVICES</h4>
        ...
        <p class="my-3 text-justify text-sm leading-8">At Master Casting and Cad, we understand that you love your jewelry and want

to keep it in the best shape possible. Whether you bought it from somewhere

else or had it made here, we are equipped to provide you with a vast variety of

repair services from rings to eyeglass repair. If you need to repair a chipped,

cracked, or abraded diamond, our expert cutters can help you in your gemstone

repair by applying advanced re-cutting techniques.</p>
        
        <p class="text-justify text-sm leading-8">
        We repair invisible settings, cracked shanks, and loose prongs. We can also

replace and reset old or missing stones. Ring polishing and rhodium plating are

available to help restore old jewelry and help keep it looking as good as it did the

day you first put it on. Ring resizing is offered as well. Using our laser machine,

we can reattach a broken pair of glasses and have them ready for use in a very

short time. We replace necklace or bracelet clasp, watch crystals, watch bands,

and we even do the watch battery replacement.
        </p>
        <div class="my-5">
    ...
    <div class="grid place-content-center w-full">
        <img src="image/index/mcc_repair.avif" alt="" class="border border-[rgb(209,96,20)] p-1 h-[400px] w-[500px]">
    </div>
</div>

</div>

<div class="lg:mt-[700px] p-20 bg-gray-200">
    <div class="">
    <h3 class="text-4xl my-2 font-medium w-4/5 mx-auto text-center" >REPAIR SERVICES</h3>
        <div class="relative w-52 bg-black h-0.5 mx-auto mt-7 mb-5">
            <span class="absolute -top-4 left-[90px] text-3xl text-[rgb(209,96,20)]"><i class="fa-sharp fa-solid fa-gem"></i></span>
        </div>
    </div>
    <div class="border-t border-gray-600">
        ...
        <div class="lg:grid lg:grid-cols-2 gap-5 my-3">
        <div>
        
        <p class="text-justify leading-8 ">
        We provide services designed to surge your special jewelry pieces. Over time, jewelry can lose its luster and brilliance, even with the highest quality of care. We can refurbish and restore any piece of jewelry that has lost its radiance. When you allow us to repair and restore your cherished gemstones, our experts will repair them with utmost care. Whether you want to resize a ring, place a stone into a new setting, or need a piece of jewelry soldered, we do our best work! We only use the finest materials to repair and restore your jewelry.
        </p> <br>

        <p class="text-justify leading-8">
        We deliver a varied number of repair services for jewelry to restore the gemstone to it's former glory. For instance, we can source and replicate the exact stone for your lost or damaged stone from the jewelry. We are also able to clean & polish your precious rings and breathe new life into worn or old jewellery.Over a long time, the jewelry sizes may vary slightly or a ring may be passed on through the family and need a slight tweak. We provide the resizing services to make the necessary alterations to ensure your ring remains the perfect fit.
        </p>
        </div>
        <div>
        <div class=" grid place-content-start">
        <h3 class="my-2 font-semibold  text-center" >Repair Services we provide :</h3>
           
            <p class="leading-8 text-justify"> <span class="text-lg font-semibold mb-5">></span>Platinum repairs</p>     
            <p class="leading-8 text-justify"><span class="text-lg font-semibold mb-5">></span> Remounts</p>         
            <p class="leading-8 text-justify"> <span class="text-lg font-semibold mb-5">></span>Invisible setting</p>
            <p class="leading-8 text-justify"> <span class="text-lg font-semibold mb-5">></span>Stone replacement</p>
            <p class="leading-8 text-justify"> <span class="text-lg font-semibold mb-5">></span>Reconstruction</p>
            <p class="leading-8 text-justify"> <span class="text-lg font-semibold mb-5">></span>Setting</p>
            <p class="leading-8 text-justify"> <span class="text-lg font-semibold mb-5">></span>Finger Fits</p>
            <p class="leading-8 text-justify"> <span class="text-lg font-semibold mb-5">></span>Restoration</p>
            <p class="leading-8 text-justify"> <span class="text-lg font-semibold mb-5">></span>Re Finishing</p>
    </div>
    </div>
    </div>
</div>
    ...
    <div>
        <div class="text-center text-white opacity-100 py-10 lg:py-0">
            ...
            <button data-modal-target="authentication-modal6" data-modal-toggle="authentication-modal6" type="button" class="px-6 py-2  border-2 border-white">Contact US</button>
        </div>
    </div>
...
<div id="authentication-modal6" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative w-full max-w-md max-h-full">
        <!-- Modal content -->
        <div class="relative  bg-[rgb(209,96,20)] rounded-lg shadow dark:bg-gray-700">
            <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-hide="authentication-modal6">
