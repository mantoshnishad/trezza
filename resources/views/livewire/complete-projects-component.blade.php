                ...
                <tbody class="w-100 border">
                    <table class="w-100 border">
                        ...
                        <tr class="text-center py-4">
                            ...
                            <td class="border text-center py-4">8725-PHOENIX-ARHAM-STB FRISCO - Copy(1)</td>
                            <td class="border text-center py-4">8725-PHOENIX HARRIS-ARHAM-STB FRISCO</td>
                            ...
                            <td class="border text-center py-4">Shipping    </td>
                            <td class="border text-center py-4">- 1 Month</td>
                            <td class="border text-center py-4">2023-07-19</td>
                            <td class="border text-center py-4"><span class="bg-info rounded-pill px-2">complete</span></td>
