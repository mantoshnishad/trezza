...
<div class="lg:absolute lg:top-[800px] grid lg:grid-cols-2 gap-5 mx-10 my-10 lg:p-8 bg-white lg:drop-shadow-lg lg:shadow-xl">
    <div class="grid place-content-center text-center">
        ...
        <h4 class="text-4xl my-2 font-medium">THE MASTER CASTERS</h4>
        ...
        <div class="relative w-52 bg-black h-0.5 mx-auto mt-7 mb-5">
            <span class="absolute -top-4 left-[90px] text-3xl text-[rgb(133,31,68)]"><i class="fa-sharp fa-solid fa-gem"></i></span>
        </div>
    ...
    <div class="grid place-content-center w-full">
        <img src="image/index/mcc_casting.avif" alt="" class="border border-[rgb(133,31,68)] p-1 h-[400px] w-[500px]">
    </div>
</div>
...
<div class="lg:mt-[700px] lg:grid lg:grid-cols-2 bg-[rgb(133,31,68)] place-items-center">
    <div>
    ...
    <div>
        <div class="text-center text-white  2 opacity-100">
         ...
         <!--    <h4 class="my-2 font-medium w-4/5 mx-auto">Contact Master Casting & Cad</h4> -->
            <address class="mb-3">
                Master Casting & Cad,<br> 68 E Madison St,<br> Chicogo, IL60602
            </address>
            <address class="mb-3">
            In person drop off and pickup only<br> 54 E Madison St, Suite 206<br> Chicago, IL 60602
            </address>
            <button type="button" class="px-6 py-2  border-2 border-white">UPLOAD FILE</button>
        </div>
    </div> 
    ...
    <div class="w-full f-full object-cover">
        <img src="image/index/con-img3-1.avif" alt="" class="w-full f-full">
    </div>
    <!-- <div>
