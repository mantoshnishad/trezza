                ...
                <div class="modal-body  px-4">
                    ...
                    <div class="row pb-3 ">
                        <div class="col-lg-3">
                            ...
                            <div class="col-lg-3">
                                <label for="floatingInput" class="my-0" style="font-weight: 600">Phone</label>
                                <input type="text" placeholder="Phone" class="col-lg rounded  my-0" {{$disabled}}
                                    wire:model="phone" style="outline: 0; padding:4px;border:1px solid black">
                                @error('phone')
                                <span style="color:red">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-6">
                            <label for="floatingInput" class="my-0" style="font-weight: 600">Address</label>
                            <input type="text" placeholder="Address" class="col-lg rounded  my-0" {{$disabled}}
                                wire:model="address" style="outline: 0; padding:4px;border:1px solid black">
                            @error('address')
                            <span style="color:red">{{$message}}</span>
                            @enderror
                        </div>
                        <div class="col-lg-6">
                            <label for="floatingInput" class="my-0" style="font-weight: 600">Alternate Contact</label>
                            <input type="text" placeholder="Alternate Contact" class="col-lg rounded  my-0" {{$disabled}}
                                wire:model="alternate_contact" style="outline: 0; padding:4px;border:1px solid black">
